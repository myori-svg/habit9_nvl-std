---
name: project-setup
description: 새 프로젝트 시작할 때 기술스택, 디렉토리 구조, AGENTS.md, docs, .gitmessage를 순서대로 세팅해주는 스킬. 새 프로젝트 시작, 초기 세팅, 프로젝트 구성할 때 사용.
...
[templates/AGENTS.md](templates/AGENTS.md)를 읽고 수집한 정보로 채워서 프로젝트 루트에 생성해.
...
```
## Step 7. 슬래시 커맨드 세팅
templates/commands/ 안의 파일들을 프로젝트의 `.Codex/commands/`에 복사해.
...
📁 생성된 구조: (디렉토리 트리)
📄 생성된 파일: AGENTS.md / docs/PRD.md / .gitmessage
🛠️ 기술 스택: (확정된 스택)
